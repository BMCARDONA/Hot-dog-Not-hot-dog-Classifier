...
# If necessary: /Applications/Python\ 3.11/Install\ Certificates.command
# Replace 3.11 with your version of Python
...
def hot_dog_model(image_shape=IMG_SIZE, data_augmentation=data_augmenter()):
    ''' Define a tf.keras model for binary classification out of the InceptionV3 model
    Arguments:
